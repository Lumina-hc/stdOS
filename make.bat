...
i686-elf-gcc -m32 -ffreestanding -nostdlib -c kernelClang\memory.c -o mem.o

i686-elf-ld -T linker.ld -o kernel.elf khead.o kernel.o cfunc.o basic.o key.o global.o idt.o std.o diskio.o fat16.o mem.o
